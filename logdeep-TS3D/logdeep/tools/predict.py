...
class Predicter:
    ...
    def predict_unsupervised(self):
        ...
        test_normal_loader, test_normal_length = generate("s2s_test_normal")
        test_abnormal_loader, test_abnormal_length = generate("s2s_test_abnormal")
        TP = 0
        FP = 0
        # Test the model
